 ...
 */
import { buildEngram, buildSlug, KIND_AGENT_ENGRAM, } from 'organism-core/bridge/nostr-wire';
...
export function memoryRecord(ev) {
    return {
        event_id: ev.id,
        agent_id: ev.agentId,
...
export function buildMemoryEngram(opts) {
    ...
    if (event.visibility === 'public') {
        throw new Error(`memory event ${event.id} is public; an NIP-AE engram's content is ` +
